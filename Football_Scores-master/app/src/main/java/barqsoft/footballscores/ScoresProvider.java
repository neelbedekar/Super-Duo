    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder)
    {
        ...
        switch (match)
        {
            case MATCHES: retCursor = mOpenHelper.getReadableDatabase().query(
                ...
                Log.e(ScoresProvider.class.getSimpleName(),"matches");break;
            case MATCHES_WITH_DATE:
                ...
                Log.e(ScoresProvider.class.getSimpleName(),"matchesdate"); break;
            case MATCHES_WITH_ID: retCursor = mOpenHelper.getReadableDatabase().query(
                ...
                Log.e(ScoresProvider.class.getSimpleName(),"matchesid"); break;
            case MATCHES_WITH_LEAGUE: retCursor = mOpenHelper.getReadableDatabase().query(
                ...
                Log.e(ScoresProvider.class.getSimpleName(),"matchesleague");break;
